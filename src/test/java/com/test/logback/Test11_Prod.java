...
public class Test11_Prod {

	final static Logger logger = LoggerFactory.getLogger(Test11_Prod.class);

	@Test
	public void testLog() {

		System.setProperty("logback.config.file.name", "/logback-test11-prod.xml");
